...
export default function ArtRiderLogo({ subtitle }: { subtitle?: string }) {
  return (
    <Link href="/" className="flex items-center gap-3 group shrink-0">
      {/* Soundwave circle */}
      <div className="w-9 h-9 rounded-full border-2 border-gray-900 group-hover:border-[#875B9A] transition-colors duration-150 flex items-center justify-center shrink-0">
        <svg viewBox="0 0 427 448" fill="currentColor" className="w-[18px] h-[18px] text-gray-900 group-hover:text-[#875B9A] transition-colors duration-150">
      ...
      <span className="font-bold text-[1.08rem] text-gray-900 tracking-tight group-hover:text-[#875B9A] transition-colors duration-150">
        ArtRider
        {subtitle && (
